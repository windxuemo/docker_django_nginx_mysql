...
from .views import create_analyze_firmware_task, select_and_create_task, download_firmware, update_result, list_task, list_all_task, delete_task, re_execute_task
