...
from .views import create_emulate_firmware_task, select_and_create_task, terminate_firmware_task, download_firmware, update_result, list_all_task, delete_task
